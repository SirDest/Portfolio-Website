      ...
      >
        <div className="pb-8 ">
          ...
          <p className="text-gray-300 py-4">
            Submit the form below or shoot me at - mygmail@gmail.com
          </p>
        </div>
        <input
        ...
        ></textarea>
        <button
          className="text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 mx-auto my-8 flex items-center
        "
        >
          Let's Collaborte
        </button>
